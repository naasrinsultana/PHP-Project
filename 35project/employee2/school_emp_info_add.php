...
<div class="container">
<hr />
  <h2>Add Employee  Personal Information</h2>
<hr />  
  <form action="school_emp_info_store.php" method="post">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="nationality" placeholder="Place Of Birth" name="nationality" required>
    </div>
    <div class="form-group">
      <label for="national_id">National ID:</label>
      <input type="text" class="form-control" id="national_id" placeholder="Place Of Birth" name="national_id" required>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="date" class="form-control" id="marital_status" placeholder="" name="marital_status" required>
    </div>
    <div class="form-group">
