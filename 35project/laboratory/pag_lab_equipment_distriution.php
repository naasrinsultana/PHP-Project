<?php
	...
	$query=mysqli_query($con,"select count(id) from school_lab_euipment_distribution");
	...
	$nquery=mysqli_query($con,"select * from school_lab_euipment_distribution $limit");
