...
<hr />  
  <form action="school_circular_cand_selection_sys_update.php" method="post">
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="applicant_id" placeholder="Applicant Id" name="applicant_id" value="<?php print $row['applicant_id']; ?>" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="interview_location" placeholder="Interview Location:" name="interview_location"  value="<?php print $row['interview_location']; ?>" required>
    </div>
    <div class="form-group">
