...
<?php
  ...
  //adding header
	...
	$sql = "select * from ceduinfo where id=".$id;
	//execute the query
...
<hr />
  <div class="row">
    ...
    <div class="col-sm-3 col-md-3"><b>Board University:</b> </div>
    <div class="col-sm-3 col-md-3"><?php print $row['board_uni'];?></div>
