...
<hr />  
  <form action="school_circular_confirmation_manag_sys_store.php" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="confirmation_message" placeholder="Confirmation Message:" name="confirmation_message" required>
    </div>
    <div class="form-group">
