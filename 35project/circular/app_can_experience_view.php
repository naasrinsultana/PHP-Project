...
<hr />	
  <div class="row">
    <div class="col-sm-3 col-md-3"><b>Company Name:</b> </div>
    <div class="col-sm-3 col-md-3">
	<?php print $row['company_name'];?></div>
    <div class="col-sm-3 col-md-3"><b>Designation:</b> </div>
    <div class="col-sm-3 col-md-3"><?php print $row['designation'];?></div>

  </div>  
<hr />
  <div class="row">

    <div class="col-sm-3 col-md-3"><b>Year:</b> </div>
    <div class="col-sm-3 col-md-3"><?php print $row['year'];?></div>
  
    <div class="col-sm-3 col-md-3"><b>salary:</b> </div>
    <div class="col-sm-3 col-md-3"><?php print $row['salary'];?></div>
<hr />
  </div> 
