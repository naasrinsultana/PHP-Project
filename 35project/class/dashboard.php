...
<div class="container">
  <h2 align="center" style="color:#660000">Dashboard</h2>
  <div class="row">
  	<div class="col-md-4 col-sm-4">
    	<a href="school_time_info.php"><img src="img/img1.jpg" class="thumbnail" width="100%" 
        height="200 px">
      <p align="center" style="font-size: 18px; color: #CC0000;">Class Time Management</p></a>
        
    </div>
  	<div class="col-md-4 col-sm-4">
    	<a href="school_event_info.php"><img src="img/event.jpg" class="thumbnail" 
        width="100%" height="200 px">
        <p align="center" style="font-size:18px; color:#CC0000;">Event Entry</p></a>
    </div>
  	<div class="col-md-4 col-sm-4">
    	<a href="event_info.php">
        <img src="img/event entry.jpg" class="thumbnail"  width="100%" height="200 px">
        <p align="center" style="font-size:18px; color:#CC0000;">Participant's Entry</p></a>
