<?php
	...
	$query=mysqli_query($con,"select count(id) from school_circular_applicant_experience_information");
	...
	$nquery=mysqli_query($con,"select * from school_circular_applicant_experience_information $limit");
