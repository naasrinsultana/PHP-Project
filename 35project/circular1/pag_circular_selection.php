<?php
	...
	$query=mysqli_query($con,"select count(id) from school_circular_candidate_selection_system");
	...
	$nquery=mysqli_query($con,"select * from school_circular_candidate_selection_system $limit");
