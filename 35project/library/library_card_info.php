...
$(document).ready(function(){
    $('.search-box input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("backend-search-card-info.php", {term: inputVal}).done(function(data){
...
<!-- search end --> 
<div align="right"><a href="library_card_info_add.php">Add Library Card</a></div>
...
<table class="table table-striped">
  <thead>
    ...
    while($row=mysqli_fetch_array($result)){
        ...
        <th>$row[name]</th>
		<th>$row[contact]</th>
		<th>$row[card_validation_date]</th>
