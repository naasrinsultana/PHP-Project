<?php
	...
	$query=mysqli_query($con,"select count(id) from school_lib_books_infor_entry_system");
	...
	$nquery=mysqli_query($con,"select * from school_lib_books_infor_entry_system $limit");
