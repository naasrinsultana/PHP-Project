...
<?php
    ...
    $sql = "select * from school_acc_income_statement where id=".$id;
    //execute query
...
<div class="container">
<hr />
  <h2><center>Edit Income Statement Information</center></h2>
<hr />  
  <form action="school_acc_income_statement_update.php" method="post">
