<?php
	...
	$query=mysqli_query($con,"select count(id) from school_libr_registration_management_system");
	...
	$nquery=mysqli_query($con,"select * from school_libr_registration_management_system $limit");
