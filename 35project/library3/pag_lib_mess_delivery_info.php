<?php
	...
	$query=mysqli_query($con,"select count(id) from school_message_delivery_management_system");
	...
	$nquery=mysqli_query($con,"select * from school_message_delivery_management_system $limit");
