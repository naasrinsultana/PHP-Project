...
<hr />  
  <form action="student_application_info_update.php" method="post">
  ...
  <textarea class="form-control" rows="5" id="permanent_address"  placeholder="Permanent Address" name="permanent_address" required> <?php print $row['permanent_address'];  ?> </textarea>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input type="date" class="form-control" id="admission_date" placeholder="Admission Date" name="admission_date" value="<?php print $row['admission_date'];  ?>" >
    </div>    
