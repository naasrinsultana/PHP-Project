...
<hr />  
  ...
  value="<?php print $_GET['id']; ?>" />
    ...
    <div class="receive_date">
      ...
      <input type="text" class="form-control" id="receive_date" placeholder="Receive Date:" name="receive_date" value = "<?php print $row['receive_date']; ?>" required>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="equipment_id" placeholder="Equipment ID" name="equipment_id" value = "<?php print $row['equipment_id']; ?>" required>
    </div>
