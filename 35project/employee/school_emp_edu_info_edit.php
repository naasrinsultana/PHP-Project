  ...
  <form action="school_emp_edu_info_update.php" method="post">
    ...
    <div class="form-group">
      ...
      <select class="form-control" id="exam_type" name="exam_type" required>
        <option value="<?php print $row['exam_type'];  ?>">
          <?php print $row['exam_type'];  ?></option>
    ...
    <div class="form-group">
      ...
      <select class="form-control" id="passing_year" name="passing_year" required>
        <option value="<?php print $row['passing_year'];  ?>">
          <?php print $row['passing_year'];  ?></option>
    ...
    <div class="form-group">
      ...
      <select class="form-control" id="board_or_university" name="board_or_university" required>
        <option value="<?php print $row['board_or_university'];  ?>">
          <?php print $row['board_or_university'];  ?></option>
