  ...
  <textarea class="form-control" rows="5" id="permanent_address"  placeholder="Permanent Address" name="permanent_address" required> <?php print $row['permanent_address'];  ?> </textarea>
    ...
    <div class="form-group">
      ...
      <select class="form-control" id="first_enrolled_class" placeholder="First Enrolled Class" name="first_enrolled_class">
      	<option value="<?php print $row['first_enrolled_class'];  ?>"><?php print $row['first_enrolled_class'];  ?></option>	   
    ...
    <div class="form-group">
      		...
      		<input type="email" class="form-control" id="email" placeholder="Enter Email" name="email" value="<?php print $row['email'];  ?>" required>
    	</div>
    <div class="form-group">
      		<label for="contact_no">Contact:</label>
      		<input type="contact_no" class="form-control" id="contact_no" placeholder="Enter Contact Number" name="contact_no" value="<?php print $row['contact_no'];  ?>" required>
    	</div>
