<?php
	...
	$query=mysqli_query($con,"select count(id) from school_lab_equipment_information");
	...
	$nquery=mysqli_query($con,"select * from school_lab_equipment_information $limit");
