...
<div class="container">
  ...
  <div class="row">
  	<div class="col-md-4 col-sm-4">
        ...
        <img src="asset/img/img1.png" class="thumbnail" width="50%"
        height="200 px">
        <p align="center">Lab Equipment Info</p></a>
        
    </div>
  	<div class="col-md-4 col-sm-4">
    	<a href="school_lab_equipment_distribution.php"><img src="img/img2.jpg" class="thumbnail" 
        width="50%" height="200 px">
