	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(deshbord/upload/<?php echo $slider[2]->image; ?>)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title"><?php echo $slider[2]->heading; ?></div>
									<div class="home_slider_subtitle"><?php echo $slider[0]->content; ?></div>
								</div>
							</div>
						</div>
					</div>
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(deshbord/upload/<?php echo $slider[1]->image; ?>)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title"><?php echo $slider[0]->heading; ?></div>
									<div class="home_slider_subtitle"><?php echo $slider[0]->content; ?></div>
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(deshbord/upload/<?php echo $slider[0]->image; ?>)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
