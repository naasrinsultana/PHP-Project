...
?>
 <form action="" method="post">
    ...
    <div class="form-group">
          ...
          <input type="text" class="form-control" id="company_name" placeholder="company_name:" name="company_name" required>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="year" class="form-control" id="year" placeholder="Year:" name="year" required>
        </div>
        <div class="form-group">
